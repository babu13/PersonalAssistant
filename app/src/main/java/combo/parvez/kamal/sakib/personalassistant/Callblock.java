...
public class Callblock extends ActionBarActivity implements OnClickListener, OnItemLongClickListener {
    ...
    private BlocklistDAO blackListDao;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_callblock);

        // Initialization of the button of the Main screen
        add_blacklist_btn = (Button) findViewById(R.id.add_blocklist_btn);
    ...
    protected void onResume() {
        ...
        blackListDao = new BlocklistDAO(this);
