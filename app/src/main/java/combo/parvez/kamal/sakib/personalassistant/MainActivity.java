...
import combo.parvez.kamal.sakib.personalassistant.Reminder.EventActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent notepad = new Intent(MainActivity.this,notepadOpen.class);
                startActivity(notepad);
                Toast.makeText(getApplicationContext(), "Add your note", Toast.LENGTH_SHORT).show();
            }
        });
...
//            //Intent user_info = new Intent(MainActivity.this,UserInfo.class);
...
//        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_alarm) {
            ...
            Intent callblock = new Intent(MainActivity.this,Callblock.class);
            startActivity(callblock);
